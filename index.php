...
if (isset($_POST['username']) && isset($_POST['password'])) {
  ...
  //$trainer = new Trainer($trainer_id, $uname, $upass);
  //$odg=$trainer->logInTrainer($trainer,$conn);
  $odg = Trainer::logInTrainer($conn, $uname, $upass);

  if ($odg->num_rows == 1) {
    echo `<script> console.log("You have successfully joined!"); </script>`;

    $_SESSION['loggedtrainerid'] = $odg->fetch_assoc()['trainerid'];
      ...
      <div class="row g-0">
        ...
        <div class="col-lg-7 px-5 pt-5">
          ...
          <form method="POST" action="#">
            ...
            <div class="form-row">
              <div class="col-lg-7">
                <input type="password" placeholder="********" name="password" class="form-control my-3 p-3" required />
              </div>
            </div>
            <div class="form-row">
              <div class="col-lg-7">
